...
void BiquadChain::processBiquad(const float * input, vector<float>& output, const int stride, const int count, const Biquad * coeffs){
	...
	for(int n = 0; n < count; n++){
		...
		output.push_back(yn[numFilters - 1]);
